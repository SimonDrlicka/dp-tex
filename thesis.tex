...
% Keywords
\FEIkeywords{inteligentné hodinky, Zepp OS, rozpoznávanie gest, zápasenie, rozhodca, prahový algoritmus, Android}
\FEIkeywordsEn{smartwatch, Zepp OS, gesture recognition, wrestling, referee, threshold algorithm, Android}
...
\FEItrainingWorkplace{Ústav informatiky a matematiky} %todo
\FEItrainingWorkplaceEn{Institute of Computer Science and Mathematics} %todo
...
%% Attachement A
\FEIappendix{Štruktúra prílohy\label{att:prilohy}}{includes/attachmentA}
