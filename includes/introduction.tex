...
lopatkovým víťazstvom. Pravidlá \Gls{uww} pritom vyžadujú
prítomnosť troch rozhodcov, čo predstavuje pre kluby
organizačnú a~finančnú záťaž a~v~praxi sa pri menších
turnajoch ich počet znižuje z~troch na dvoch. Práve
kombinácia ustálených pohybov ruky a~potreby presného zápisu
robí zo zápasenia vhodnú doménu pre automatizovanú detekciu
gest pomocou inteligentných hodiniek, ktorá by mohla
zjednodušiť prácu rozhodcom a~prispieť k~zníženiu nákladov
spojených s~organizáciou zápasov.
...
vychádzajú z~oficiálnych pravidiel \Gls{uww} a~z gest,
...
rozhodcovských aplikácií pre inteligentné hodinky, aplikácií
