...
výskum zameraný na rozpoznávanie gest všade tam, kde je to možné.  
Rozpoznávame gestá ruky pomocou senzorov pohybu pripevnených na zápästí, 
...
\Gls{imu} senzorov pre detekciu gest. \cite{deepgesture}
...
pre rozhodcov v~zápasení pre operačný systém Zepp OS.
