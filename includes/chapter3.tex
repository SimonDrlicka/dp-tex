...
Pre prístup k~senzorom hodiniek poskytuje Zepp OS
modul \texttt{@zos/sensor}, ktorý sprístupňuje
akcelerometer a~gyroskop od verzie API\_LEVEL~3.0
...
takisto v~troch osiach. Oba senzory fungujú
...
pokrýva celý vývojový cyklus aplikácie pre Zepp OS --
...
prostredníctvom \Gls{ble} (Bluetooth Low Energy).
...
Android Studio je oficiálne integrované vývojové
prostredie (\Gls{ide}) pre vývoj Android aplikácií.
Je postavené na platforme IntelliJ IDEA od
...
offline pomocné skripty pre kalibráciu hraničných
