...
\Gls{uww} sme identifikovali kľúčové gestá, ktoré sú pre
...
prostredí existuje viacero rozhodcovských aplikácií pre inteligentné
...
\begin{itemize}
    \item doplnenie kalibračnej fázy pred prvým
        ...
        každé gesto niekoľkokrát a~hraničné intervaly hodnôt by sa
