...
\Gls{csv} súboru pre vizualizáciu a spracovanie v~Python skripte
...
reálny priebeh zápasu. V~logu je viditeľná sekvencia bodovania, napomenutí
pre obe strany s~následným pridelením bodov súperovi,
signalizácia pasivity červeného zápasníka a~na záver
signalizácia TOUCHE -- lopatkového víťazstva.

% TODO: Vymeniť fotku, uz nema davat body za pasivitu, ale rovno trestny bod
\begin{figure}[H]
  \centering
...
prostredníctvom hodiniek hlavného rozhodcu.

V~tomto móde sme takisto vypli vibráciu pri detekcii
