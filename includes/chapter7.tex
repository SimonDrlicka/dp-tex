...
viditeľné prechody hodnôt zodpovedajúce aktivačnému
gestu \uv{Rise Arm} (vstup do režimu \texttt{GESTURE\_RED})
...
\subsubsection{Hlavné rozdiely medzi produkčným a~debug módom}
...
implementáciu ďalších gest a funkcionalít, ktoré
presahujú rámec diplomovej práce.
...
prostredníctvom hodiniek hlavného rozhodcu.V~produkčnom móde
sme takisto vypli vibráciu pri detekcii
aktivačných gest bodovania (\uv{Rise Arm} a~\uv{Hand Back})
z~dôvodu príliš častej vibračnej odozvy, ktorá by mohla
byť pre rozhodcu rušivá a~mätúca. Tieto gestá sa
počas zápasu vykonávajú pri každom bodovaní, čo by
viedlo k~zbytočne nadmernému počtu
vibračných impulzov v~krátkom časovom úseku.
