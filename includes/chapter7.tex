...
zápästia, ktoré sú charakteristické pre gesto \uv{Flick},
sme následne pridali aj spracovanie údajov
...
slúži na vizualizáciu grafov a~definovanie intervalov
pre jednotlivé gestá popísané v~kapitole~\ref{chapter:gesta}.
...
hraničné intervaly hodnôt pre aktuálne zvolené gesto. Výber
...
\label{sec:zber-dát}
Dáta na definovanie intervalov hodnôt jednotlivých gest sme zbierali
...
hodnoty preto musia obsahovať dostatočne široký
interval, ktorý zohľadňuje nielen odchýlky
v~polohe ruky, ale aj skutočnosť, že sa rozhodca
počas zápasu môže nachádzať v~pohybe. Priemerná
šírka definovaných hraničných intervalov naprieč všetkými
osami a~gestami dosahuje hodnotu približne
$4{,}1~\text{m/s}^2$, čo zodpovedá tolerancii
$\pm\,2{,}0~\text{m/s}^2$ od strednej hodnoty
intervalu.
...
Po uložení hraničných intervalov hodnôt nástroj automaticky
...
manuálnu úpravu hraničných intervalov hodnôt jednotlivých osí
...
\subsection{Aplikácia na rozpoznávanie gest}
...
\begin{itemize}
  \item \textbf{WAITING} -- východiskový režim,
        ...
        Gestá \uv{Flick} (viď podsekciu~\ref{subsubsec:flick})
  ...
  \item \textbf{GESTURE\_RED} -- režim bodovania
        ...
        Všetky gestá \uv{Flick} zaznamenané počas
...
gestá \uv{Flick}. O~tom, ktorému zápasníkovi sa
...
ktoré zodpovedajú jednotlivým gestám \uv{Flick}.
...
nasledovali gestá \uv{Flick}. Farebné pásma
v~pozadí grafu akcelerometra znázorňujú nastavené
hraničné intervaly pre rozpoznanie polohy ruky
\uv{Rise Arm}.
...
Pre prípad chybnej detekcie alebo nesprávneho
zaznamenania udalosti je každý záznam v~logu
opatrený tlačidlom v~tvare krížika, ktoré umožňuje
rozhodcovi alebo jeho asistentovi manuálne odstrániť
zápis. Na mazanie záznamov sme zvolili prístup
\textit{soft delete} -- záznam nie je z~logu fyzicky
odstránený, ale je iba označený ako neplatný a~vizuálne
prečiarknutý. Vďaka tomu zostáva celá história
zaznamenaných udalostí dohľadateľná aj po prípadnom
zmazaní. Pri označení udalosti ako neplatnej sa
zároveň automaticky prepočíta priebežné skóre, aby
zodpovedalo aktuálnemu stavu zápasu.
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{
    ...
    \midrule
    TOUCHE                        & 5\,$\times$\,krátky       & \textendash{}                           & oba              \\
    \midrule
    Prechod do režimu napomenutia & 2\,$\times$\,krátky       & \textendash{}                           & oba              \\
    \midrule
    Aktivácia režimu bodovania    & 1\,$\times$\,krátky      & \textendash{}                           & len \emph{debug} \\
    \midrule
    Pasivita                      & 2\,$\times$\,krátky       & \textendash{}                           & oba              \\
    \midrule
    Trestný bod za pasivitu       & 1\,$\times$\,dlhý         & \textendash{}                           & len \emph{debug} \\
    \bottomrule
  \end{tabularx}
