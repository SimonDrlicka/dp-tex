...
gesta \uv{Rise Arm} a zobrazenie bodu, kedy dochádza k detekcií tohto gesta.
...
gesta \uv{Hand Back} a zobrazenie bodu, kedy dochádza k detekcií tohto gesta.
...
Odpočet pasivity sme sa nakoniec rozhodli implementovať
iba v debug móde aplikácie a nie v produkčnom móde (módy sú
definované v podsekciách~\ref{app:debug-final} a~\ref{app:prod-final}).
...
(\uv{Gesto rozpoznané} v~čase 2{,}96\,s) sa aplikácia
prepne do režimu napomenutia červeného zápasníka. V~druhej fáze rozhodca
vykonal tri po sebe nasledujúce flickovacie gestá, ktoré sú v~hornej časti grafu
...
gestá v~časoch 6{,}25\,s a~7{,}01\,s.
