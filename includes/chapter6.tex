...
Charakteristickým znakom polohy pri aktivačnom geste sú záporné
...
(\uv{Gesto rozpoznané} v~čase 2{,}99\,s). Aplikácia sa tým prepne do režimu
napomenutia modrého zápasníka. V~druhej fáze rozhodca vykonal dve po sebe nasledujúce flickovacie
gestá v~časoch 6{,}25\,s a~7{,}01\,s, ktoré sú v~hornej
...
Každý z~týchto výkyvov pridelil jeden bod červenému zápasníkovi. Počas tohto gesta sú
body analogicky prideľované iba červenému zápasníkovi. V~tretej fáze (\uv{Hand down} v~čase 9{,}34\,s) sa hodnoty
akcelerometra ustália v~rozsahoch zodpovedajúcich neutrálnej polohe ruky,
