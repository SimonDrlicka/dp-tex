...
Pri napomenutí modrého zápasníka rozhodca presunie ľavú ruku (s~hodinkami)
za chrbát do oblasti krížov, pričom zápästie je rotované tak, že displej
hodiniek smeruje k~zemi a~otvorená dlaň smeruje nahor (v~približne 45°
uhle). Pravou rukou (s~modrou manžetou) ukazuje na previnilého modrého
zápasníka. Po detekcii sa aplikácia automaticky prepne do režimu bodovania,
kde všetky body idú červenému zápasníkovi.
...
gyroskopických a~akcelerometrických dát počas vykonania aktivačného gesta
\uv{NAPOMENUTIE -- modrý} a~následnej sekvencie bodovania. V~prvej fáze (\uv{Gesto rozpoznané} v~čase 2{,}99\,s) sa aplikácia
prepne do režimu napomenutia modrého zápasníka.
V~druhej fáze rozhodca vykonal dve po sebe nasledujúce flickovacie
gestá v~časoch 6{,}25\,s a~7{,}01\,s.
Každý z~týchto výkyvov pridelil jeden bod červenému zápasníkovi.
Počas tohto gesta sú body analogicky prideľované iba červenému zápasníkovi.

V~tretej fáze (\uv{Hand down} v~čase 9{,}34\,s) sa hodnoty
akcelerometra ustália v~rozsahoch zodpovedajúcich polohe gesta \uv{Hand Down},
...
Hoci je poloha ruky pri tomto geste podobná aktivačnému gestu \uv{Hand Back}
(obe gestá majú ruku za chrbtom v~oblasti krížov), kľúčový rozdiel je
v~rotácii zápästia. Pri \uv{Hand Back} smeruje displej hodiniek k~chrbtu,
pri \uv{NAPOMENUTIE -- modrý} smeruje displej k~zemi. Tento rozdiel sa
prejavuje v~rôznych osiach akcelerometra -- pri \uv{Hand Back} dosahuje
výrazne záporné hodnoty os $a_z$, pri \uv{NAPOMENUTIE -- modrý} os $a_y$,
čím je zabezpečená spoľahlivá detekcia bez rizika zámeny.

\subsection{Gesto TOUCHE}

Gesto \uv{TOUCHE} slúži na signalizáciu lopatkového
víťazstva, ktoré okamžite ukončuje zápas (podrobne
popísané v~kapitole~\ref{chapter:zapasenie}).
Keďže je vždy jednoznačné, ktorý zápasník
...
cez hruď ustália v~rámci definovaných hraničných pásiem.
